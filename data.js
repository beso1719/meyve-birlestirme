...
const LEVELS = [
  { id: 1,  name: "Başlangıç",     emoji: "🍒", target: 300,  spawnMaxTier: 4, reward: 20 },
  { id: 2,  name: "Dar Kavanoz",   emoji: "🫙", target: 500,  spawnMaxTier: 4, jarWidthRatio: 0.72, reward: 25 },
  { id: 3,  name: "Zaman Yarışı",  emoji: "⏱️", target: 600,  spawnMaxTier: 4, timeLimit: 90, reward: 25 },
  { id: 4,  name: "Az Hamle",      emoji: "🎯", target: 700,  spawnMaxTier: 4, maxDrops: 30, reward: 30 },
  { id: 5,  name: "Ağır Çekim",    emoji: "🪨", target: 900,  spawnMaxTier: 5, gravity: 2.2, reward: 30 },
  { id: 6,  name: "Bombalar",      emoji: "💣", target: 1000, spawnMaxTier: 4, bombChance: 0.12, reward: 35 },
  { id: 7,  name: "Buz Pateni",    emoji: "🧊", target: 1100, spawnMaxTier: 5, friction: 0.02, restitution: 0.45, reward: 35 },
  { id: 8,  name: "Sadece Büyük",  emoji: "🍍", target: 1300, spawnTiers: [2, 3, 4, 5], reward: 40 },
  { id: 9,  name: "Yükselen Lav",  emoji: "🌋", target: 1400, spawnMaxTier: 4, risingDeath: 3.5, reward: 40 },
  { id: 10, name: "Düşük Çekim",   emoji: "🎈", target: 1500, spawnMaxTier: 5, gravity: 0.7, restitution: 0.5, reward: 45 },
  { id: 11, name: "Kaos",          emoji: "🌀", target: 1800, spawnMaxTier: 5, gravity: 1.8, bombChance: 0.08, jarWidthRatio: 0.85, reward: 50 },
  { id: 12, name: "Karpuz Ustası", emoji: "🍉", target: 2500, spawnMaxTier: 5, maxDrops: 60, reward: 60 },
  { id: 13, name: "Dar & Hızlı",   emoji: "🏃", target: 1600, spawnMaxTier: 4, jarWidthRatio: 0.7, timeLimit: 80, reward: 55 },
  { id: 14, name: "Bomba Yağmuru", emoji: "🌧️", target: 1900, spawnMaxTier: 4, bombChance: 0.22, reward: 55 },
  { id: 15, name: "Cam Kavanoz",   emoji: "🪟", target: 2000, spawnMaxTier: 5, friction: 0.01, restitution: 0.55, jarWidthRatio: 0.8, reward: 60 },
  { id: 16, name: "Volkan",        emoji: "🌋", target: 2200, spawnMaxTier: 5, risingDeath: 5, reward: 65 },
  { id: 17, name: "Uzayda",        emoji: "🚀", target: 2300, spawnMaxTier: 6, gravity: 0.5, restitution: 0.6, reward: 70 },
  { id: 18, name: "Tek Hamlede",   emoji: "🎴", target: 2400, spawnTiers: [3, 4, 5], maxDrops: 45, reward: 70 },
  { id: 19, name: "Fırtına",       emoji: "🌪️", target: 2600, spawnMaxTier: 6, gravity: 2.4, bombChance: 0.1, jarWidthRatio: 0.78, reward: 75 },
  { id: 20, name: "Buzul Çağı",    emoji: "❄️", target: 2800, spawnMaxTier: 6, friction: 0.005, restitution: 0.5, timeLimit: 120, reward: 80 },
  { id: 21, name: "Yağmurlu Lav",  emoji: "☄️", target: 3000, spawnMaxTier: 5, risingDeath: 4, bombChance: 0.12, reward: 85 },
  { id: 22, name: "İğne Deliği",   emoji: "🪡", target: 3200, spawnMaxTier: 6, jarWidthRatio: 0.62, reward: 90 },
  { id: 23, name: "Son Sınav",     emoji: "🎓", target: 3600, spawnMaxTier: 6, gravity: 1.9, bombChance: 0.1, maxDrops: 80, reward: 100 },
  { id: 24, name: "Karpuz Kralı",  emoji: "👑", target: 4500, spawnMaxTier: 6, jarWidthRatio: 0.85, reward: 150 },
];
